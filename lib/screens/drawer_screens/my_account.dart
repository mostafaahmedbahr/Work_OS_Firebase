    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          onPressed: (){
           setState(() {
             !isSameUser ?  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)
             {
                  ...
                  child:  Padding(
                    ...
                    child: Column(
                      ...
                      children:     [
                        ...
                        isSameUser? Container(): const SizedBox(height: 20,),
                        isSameUser? Container():  const Padding(
                          padding: EdgeInsets.symmetric(
                            vertical: 20,
                          ),
                          child: Divider(thickness: 2,),
                        ),
                        isSameUser? Container(): const SizedBox(height: 10,),
